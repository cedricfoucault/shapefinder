...
${OBJECTDIR}/wrap.o: wrap.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/wrap.o wrap.c

${OBJECTDIR}/freqprocess.o: freqprocess.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/freqprocess.o freqprocess.c
...
${OBJECTDIR}/findShape.o: findShape.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/findShape.o findShape.c

${OBJECTDIR}/traceTrajectory.o: traceTrajectory.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/traceTrajectory.o traceTrajectory.c
